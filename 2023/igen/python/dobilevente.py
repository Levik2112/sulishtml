...
#definiálunk egy függvényt aminek a neve csucsBeker,zárójelben a paramétere ami "melyiket"
def csucsBeker(melyiket):
#Bekéri a hárámszög csúcsainak koordinátáit
    A=input("Adja meg a háromszög " +  melyiket + "csúcsának koordinátáit, vesszővel elválasztva (pl.:0, 15): ")
#kicseréli a felesleges whitespaceket és elválasztja a vesszőnél a számokat
    A=A.replace(" ","").split(",")
    A[0]=int(A[0])
    A[1]=int(A[1])
...
#amig az ujra nem hamis addig folytatja
while ujra!=False:
